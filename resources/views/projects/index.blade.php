...
<main class="main-container">
        <article>
            <div class="row1">
                <a href="/projects" class="path">My Projects</a>
                <a href="/projects/create" class="addProject">Add Project</a>
            </div>
            <div class="row2">
                   ...
                   @foreach ( $project->activity as $activity)
                        @if ($activity->description == "created_project") 
                            ...
                            <div class="activity">
                                <div class="div-one">
                                    <a href="#">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="20" viewBox="0 0 90 45" class="text-default relative" style="top: 2px">
                                    ...
                                    <p> @include("projects.activity.{$activity->description}")</p>
                                </div>
